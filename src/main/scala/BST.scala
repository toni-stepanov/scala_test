...
//  private sealed trait BTree[Key, Value]
//
//  private case object Tip extends BTree[K, V]
//
//  private case class Branch[Key, Value](key: Key, elem: Value,
//                                  left: BTree[Key, Value], right: BTree[Key, Value]) extends BTree[Key, Value]
//
